...
const GameModeVideoPlayer = () => {
  ...
  const {
    ...
    bonusResumeAfterVideo: Boolean(ctx.bonusResumeAfterVideo),
    setBonusResumeAfterVideo: ctx.setBonusResumeAfterVideo || (() => {}),
    setBonusCorrectStreak: ctx.setBonusCorrectStreak || (() => {}),
    startBonusNextQuiz: ctx.startBonusNextQuiz || (() => Promise.resolve()),
  }));
